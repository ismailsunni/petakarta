...
export async function uploadDataset(file, userId, name = null) {
  ...
  try {
    ...
    return { data: null, error: { message: 'Invalid GeoJSON file: ' + err.message } }
  }
  ...
  if (insertError) {
    ...
    return { data: null, error: { message: 'Failed to save dataset metadata: ' + insertError.message } }
  }
...
export async function fetchUserDatasets(userId) {
  ...
  if (error) {
    return { data: null, error: { message: 'Failed to fetch datasets: ' + error.message } }
  }
...
export async function downloadDataset(storagePath) {
  ...
  if (error) {
    return { data: null, error: { message: 'Failed to download dataset: ' + error.message } }
  }
  ...
  try {
    ...
    return { data: null, error: { message: 'Failed to parse dataset: ' + err.message } }
  }
}
...
export async function renameDataset(datasetId, newName) {
  ...
  if (error) {
    return { data: null, error: { message: 'Failed to rename dataset: ' + error.message } }
  }
...
export async function deleteDataset(datasetId, storagePath) {
  ...
  if (storageError) {
    return { error: { message: 'Failed to delete file: ' + storageError.message } }
  }
  ...
  if (dbError) {
    return { error: { message: 'Failed to delete dataset metadata: ' + dbError.message } }
  }
...
function analyzeGeoJSON(geojson) {
  ...
  const geometryType = Object.entries(typeCounts)
